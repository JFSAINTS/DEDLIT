...
async function comfyGenerate({ prompt, negative, width, height, steps, cfg }) {
  ...
  // esperar el resultado (hasta 3 min)
  for (let i = 0; i < 180; i++) {
  ...
  throw new Error('ComfyUI no devolvió la imagen en 3 minutos');
}
...
module.exports = { REGISTRY, listModels, chatStream, checkLocal, generateImage, generateSpeech, transcribe, sdCheck, sdGenerate, comfyCheck, comfyGenerate, embed, _test: { baseUrl, toAnthropicMessages } };
