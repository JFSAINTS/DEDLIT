...
const DEFAULTS = {
  ...
  sdWebuiPath: '', // carpeta de instalación de SD WebUI (vacío = ~/.dedlit/stable-diffusion-webui)
  ...
  fallbackChain: [], // ["proveedor:modelo", …] — reserva si el principal falla por cuota
  autoUpdateCheck: true, // comprobar nueva versión al abrir (GitHub Releases)
  lanHost: false, // escuchar también en la red local (requiere contraseña)
  lanHttps: false, // servir el acceso LAN por HTTPS (certificado autofirmado)
  lanPasswordHash: '', // sha256 de la contraseña de acceso remoto
  temperature: 0.7,
