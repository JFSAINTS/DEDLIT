...
- `lib/agent.js` — herramientas del modo agente (list_directory, read_file, write_file, run_command) con categorías read/write/command que controlan si se pide aprobación al usuario.
