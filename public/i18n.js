...
const I18N = {
  en: {
    ...
    '⬇ Instalar': '⬇ Install',
    '▶ Lanzar': '▶ Launch',
    'Instalar o lanzar Stable Diffusion': 'Install or launch Stable Diffusion',
    'Instalar o lanzar ComfyUI': 'Install or launch ComfyUI',
    '🎬 Webcam': '🎬 Webcam',
    'Abrir DEDLIT Webcam en una pestaña propia: creador de filtros, modo VTuber (PNG y VRM) y Lucy Realtime': 'Open DEDLIT Webcam in its own tab: filter creator, VTuber mode (PNG & VRM) and Lucy Realtime',
    ...
    // Cámara IA
    '🎥 Cámara IA': '🎥 AI Camera',
    'Webcam con efectos en tiempo real y restilizado IA en vivo (Stable Diffusion local)': 'Webcam with real-time effects and live AI restyling (local Stable Diffusion)',
    'Backend de restilizado IA detectado': 'Detected AI restyle backend',
    'Cámara': 'Camera',
    'Efecto en tiempo real': 'Real-time effect',
    'Espejo': 'Mirror',
    'Restilizado IA (en vivo)': 'AI restyle (live)',
    'Describe el estilo… p. ej.: anime style, cel shading': 'Describe the style… e.g.: anime style, cel shading',
    'Intensidad': 'Intensity',
    'Pasos': 'Steps',
    'Imagen de referencia (skin)': 'Reference image (skin)',
    'Quitar referencia': 'Remove reference',
    '🖼 Elegir imagen…': '🖼 Choose image…',
    'Peso ref.': 'Ref. weight',
    'Mis skins': 'My skins',
    '💾 guardar': '💾 save',
    'Guardar el estilo actual como skin': 'Save the current style as a skin',
    'Ajusta el estilo y guárdalo con 💾 para reutilizarlo.': 'Tune the style and save it with 💾 to reuse it.',
    '📸 Capturar': '📸 Capture',
    'Capturar fotograma y adjuntarlo al chat': 'Capture a frame and attach it to the chat',
    '⏺ Grabar': '⏺ Record',
    '⏹ Parar': '⏹ Stop',
    'Grabar la vista en vídeo (webm)': 'Record the view as video (webm)',
    '📎 Captura adjuntada al chat': '📎 Snapshot attached to the chat',
    '🔴 sin backend IA (solo efectos)': '🔴 no AI backend (effects only)',
    '🤖 generando primer fotograma…': '🤖 generating first frame…',
    '⚠ Arranca Stable Diffusion (con --api) o ComfyUI para el restilizado IA': '⚠ Start Stable Diffusion (with --api) or ComfyUI for AI restyling',
    '⚠ Este navegador no soporta grabación': '⚠ This browser does not support recording',
    'Sin IP-Adapter (extensión ControlNet): la referencia se funde sobre el fotograma — efecto más suave. Instala ControlNet + un modelo ip-adapter en SD WebUI para aplicarla de verdad.': 'No IP-Adapter (ControlNet extension): the reference is blended into the frame — a softer effect. Install ControlNet + an ip-adapter model in SD WebUI to truly apply it.',
    '✨ Normal': '✨ Normal',
    '🕹 Pixelado': '🕹 Pixelated',
    '💥 Cómic': '💥 Comic',
    '🌡 Térmico': '🌡 Thermal',
